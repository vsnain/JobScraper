...
if __name__ == '__main__':
    # Schedule the job to run twice a day at 1AM and 11PM
    schedule.every().day.at('01:00').do(scrape_indeed_job_count)
    schedule.every().day.at('23:00').do(scrape_indeed_job_count)
